                            ...
                            <form onSubmit={postData}>
                                <div className="row">
                                    ...
                                    <div className="col-md-12 mb-3">
                                        ...
                                        <textarea name="shortDescription" rows={4} onChange={getInputData} className={`form-control ${show && errorMessage.shortDescription ? 'border-danger' : 'border-dark'}`} placeholder='Short Description' />
